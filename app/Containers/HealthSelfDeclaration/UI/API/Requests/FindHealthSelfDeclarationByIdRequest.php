...
/**
 * Class FindHealthSelfDeclarationByIdRequest.
 */
class FindHealthSelfDeclarationByIdRequest extends Request
{
     ...
     * @var string
     */
    protected $transporter = FindHealthSelfDeclarationByIdTransporter::class;
