...
/**
 * Class DeleteEducationalBackgroundRequest.
 */
class DeleteEducationalBackgroundRequest extends Request
{
     ...
     * @var string
     */
    protected $transporter = DeleteEducationalBackgroundTransporter::class;
